...
architecture STRUCTURE of debouncer_0_debouncer is
  ...
  signal btn_out_i_8_n_0 : STD_LOGIC;
...
btn_out_i_3: unisim.vcomponents.LUT6
    generic map(
...
btn_out_i_4: unisim.vcomponents.LUT6
    generic map(
...
btn_out_i_5: unisim.vcomponents.LUT6
    generic map(
...
btn_out_i_6: unisim.vcomponents.LUT6
    generic map(
...
btn_out_i_7: unisim.vcomponents.LUT6
    generic map(
...
btn_out_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
entity debouncer_0 is
  ...
  attribute X_CORE_INFO of debouncer_0 : entity is "debouncer,Vivado 2022.2";
end debouncer_0;
