...
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { start_btn }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
...
## USB-UART Interface
set_property -dict { PACKAGE_PIN D10   IOSTANDARD LVCMOS33 } [get_ports { uart_rxd_out }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out  ARTY -> PC
#set_property -dict { PACKAGE_PIN A9    IOSTANDARD LVCMOS33 } [get_ports { uart_txd_in }]; #IO_L14N_T2_SRCC_16 Sch=uart_txd_in    ARTY <- PC
