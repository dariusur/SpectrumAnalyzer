...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xbip_utils_v3_0_10 -L dft_v4_2_3 -L xil_defaultlib -L secureip -L xpm --snapshot dft_0 xil_defaultlib.dft_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  dft_0 -key {Behavioral:sim_1:Functional:dft_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dft_0.wdb xsim.dir)
