...
#
# Generated by export_simulation on Sat Jan 06 16:02:03 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './dft_0.sh' script.
...
./dft_0.sh -noclean_files

For more information on the script, please type './dft_0.sh -help'.
