...
#
# Generated by export_simulation on Fri Jan 12 12:34:53 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './debouncer_0.sh' script.

./debouncer_0.sh -reset_run
...
./debouncer_0.sh -noclean_files

For more information on the script, please type './debouncer_0.sh -help'.
