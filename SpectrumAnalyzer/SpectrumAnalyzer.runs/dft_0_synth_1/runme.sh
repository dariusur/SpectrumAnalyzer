...
HD_PWD='C:/Users/Darius/Desktop/coding_stuff/projects_for_resume/SpectrumAnalyzer/Vivado/DFT_TEST_2/DFT_TEST_2.runs/dft_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dft_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dft_0.tcl
